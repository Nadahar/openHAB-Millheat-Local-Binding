 ...
 */
@NonNullByDefault
public class OpenWindowParametersResponse extends OpenWindowParameters implements Response { // TODO: (Nad) Header + JavaDocs
    ...
    @Override
    public String toString() { //TODO: (Nad) Add missing

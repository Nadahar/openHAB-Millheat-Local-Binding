...
public class MillConfigDescriptionProvider implements ConfigDescriptionProvider {
    ...
    public void enableDescriptions(@Nullable URI uri, @Nullable String... configParameterNames) {
        ...
        synchronized (this) {
            ...
            for (String configParameterName : configParameterNames) {
                ...
                parameter = DescriptionParameter.typeOf(configParameterName);
                if (parameter == null) {
                    logger.warn(
                ...
                thingMap.put(configParameterName, parameter.getConfigDescriptionParameter(null, null, null));
            }
            return;
        }
    }
    ...
    public static enum DescriptionParameter {
        ...
        @Nullable
        public static DescriptionParameter typeOf(@Nullable String name) {
            if (name == null) {
                return null;
            }

...
@NonNullByDefault
public class MillOilActions extends MillBaseActions { // TODO: (Nad) Javadocs
    ...
    public static void setOpenWindowParameters(
        ...
        ((MillOilActions) actions).setOpenWindowParameters(dropTempThr, dropTimeRange, incTempThr, incTimeRange, maxTime);
    }
